...
Веб-приложение для сбора любительских метеонаблюдений (Республика Коми):
точки наблюдения, замеры с офлайн-черновиками, модерация, карта, отчёты.
Реализовано по ТЗ (ред. 2): функции FR-001…FR-014, модель данных п. 4.7.1.
